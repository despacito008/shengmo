        ...
        public void onUploadSucceed() {
            ...
            runOnUiThread(new Runnable() {
                ...
                public void run() {
                    ...
                    String url = "scheme://mainhost/mainDetail";//在主项目AndroidManManifest中设置的跳转地址
                    //host和path

//                    Intent intent = new Intent();
                    Intent intent = new Intent("com.aiwujie.alivideo",
                            Uri.parse(url));
//                    intent.setAction("com.aiwujie.alivideo");
//                    intent.addCategory(Intent.CATEGORY_DEFAULT);
                    intent.putExtra("video_url",mVideoUrl);
                    intent.putExtra("cover_url",mImageUrl);
                    intent.putExtra("video_id",videoId);
                    intent.putExtra("video_w",mWidth);
                    intent.putExtra("video_h",mHeight);
                    startActivity(intent);
