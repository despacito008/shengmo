...
class GroupInviteAttentationAdapter(val context: Context, var dataList: ArrayList<GzFsHyListviewData.DataBean>) : RecyclerView.Adapter<GroupInviteAttentationAdapter.GroupInviteChatHolder>() {
