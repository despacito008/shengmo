 ...
 **/
class HighFansFragment :LazyFragment() {
    companion object {
        var fragment: HighFansFragment? = null
        fun newInstance(): HighFansFragment {
            if (fragment == null) {
                fragment = HighFansFragment()
            }
            return fragment as HighFansFragment
        }
    ...
    fun getData() {
        HttpHelper.getInstance().highFansList(page.toString(), keyWords, object : HttpCodeMsgListener {
