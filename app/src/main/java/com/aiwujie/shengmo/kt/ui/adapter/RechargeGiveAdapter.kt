...
class RechargeGiveAdapter(var context:Context, var dataList:List<ConsumptionGiveData.DataBean>): RecyclerView.Adapter<RechargeGiveAdapter.ReceiveGiftHolder>() {
