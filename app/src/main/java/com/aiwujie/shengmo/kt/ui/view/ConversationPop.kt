...
class ConversationPop(context: Context):BasePopupWindow(context) {

    private var mConversationLayout:ConversationLayout = findViewById(R.id.conversation_layout)
    ...
    init {
        ...
        activity = context as LiveRoomAnchorActivity
