 ...
 * 动态 - 关注
 */
class VideoDynamicFragment : NormalListFragment() {
    ...
    companion object {
        fun newInstance(mode: String): VideoDynamicFragment {
            val args = Bundle()
            args.putString("mode",mode)
            val fragment = VideoDynamicFragment()
    ...
    override fun initView(rootView: View) {
        ...
        rvSearchResult.addOnScrollListener(object: OnScrollListener() {
            override fun onScrolled(recyclerView: RecyclerView?, dx: Int, dy: Int) {
                ...
                if (dy > 0) {
                    (parentFragment as FragmentDynamicPlaza).hideTab()
                } else {
                    (parentFragment as FragmentDynamicPlaza).showTab()
                }
            }
    ...
    var lastid = ""
    var page = 0
    var itemDecoration:SpaceItemDecoration? = null
                        ...
                        0 -> {
                            ...
                            with(rvSearchResult) {
                                ...
                                if (itemDecoration == null) {
                                    itemDecoration = SpaceItemDecoration(context, 10, true)
    ...
    fun getHeaderView(): View? {
        return LayoutInflater.from(activity).inflate(R.layout.layout_header_fragment_playback, null)
    }
}