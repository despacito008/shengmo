...
class HighAddReasonPop : BasePopupWindow {
    private var mTipText = ""
    private var mType = ""    // 2  取消审核  3 隐藏用户
    ...
    constructor(context: Context, str: String,topId: String,type:String) : this(context) {
        mTipText = str
        mType = type
        mTopId = topId
        initView()
   ...
   private fun initView() {
    ...
    override fun onCreateContentView(): View {
        return createPopupById(R.layout.app_add_high_reason_pop)
    }
}