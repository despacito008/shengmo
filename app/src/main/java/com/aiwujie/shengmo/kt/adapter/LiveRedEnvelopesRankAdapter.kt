...
class LiveRedEnvelopesRankAdapter(var context:Context, var rankList:List<LiveRankBean.DataBean>, var type:Int): RecyclerView.Adapter<LiveRedEnvelopesRankAdapter.AnchorRankHolder>()  {
    ...
    override fun onCreateViewHolder(parent: ViewGroup?, viewType: Int): AnchorRankHolder {
       return AnchorRankHolder(LayoutInflater.from(context).inflate(R.layout.app_item_red_bag_ranking,parent,false))
    }
