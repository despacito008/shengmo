...
public class Config {
     ...
     */
    public static final int STREAMING_WIDTH = 576;
    public static final int STREAMING_HEIGHT = 960;
    public static final int STREAMING_FPS = 20;

    public static final int SMALL_STREAMING_WIDTH = 288;
    public static final int SMALL_STREAMING_HEIGHT = 352;

//    public static final int STREAMING_WIDTH = 480;
//    public static final int STREAMING_HEIGHT = 640;
//    public static final int STREAMING_FPS = 20;

    public static final int STREAMING_BITRATE = 2500 * 1000;
    ...
    public static final int T_STREAMING_WIDTH = 480;
    public static final int T_STREAMING_HEIGHT = 848;
}
