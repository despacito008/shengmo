package com.aiwujie.shengmo.view.indicator;
...
class BaseCircleIndicator extends LinearLayout {
    ...
    private void init(Context context, AttributeSet attrs) {
        CircleIndicatorConfig config = handleTypedArray(context, attrs);
        initialize(config);
    ...
    private CircleIndicatorConfig handleTypedArray(Context context, AttributeSet attrs) {
        CircleIndicatorConfig config = new CircleIndicatorConfig();
        if (attrs == null) {
            return config;
        }
    ...
    public void initialize(CircleIndicatorConfig config) {
    ...
    protected Animator createAnimatorOut(CircleIndicatorConfig config) {
        return AnimatorInflater.loadAnimator(getContext(), config.animatorResId);
    }

    protected Animator createAnimatorIn(CircleIndicatorConfig config) {
        Animator animatorIn;
