...
import com.aiwujie.shengmo.fragment.purserecordfragment.FragmentBalance;
...
public class HuiYuanBillActivity extends AppCompatActivity  {
    ...
    private void setData() {
        ...
        mTitleList.add("获赠记录");
        //添加页卡视图
        mViewList.add(new FragmentBalance());
