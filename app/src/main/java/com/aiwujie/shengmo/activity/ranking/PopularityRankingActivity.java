...
public class PopularityRankingActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.app_activity_ranking_popularity);
    ...
    void changeTitleBarColor(boolean isDark) {
        if (isDark) {
            llPopularityRankingTitleBar.setBackgroundResource(R.color.girlColor);
        } else {
