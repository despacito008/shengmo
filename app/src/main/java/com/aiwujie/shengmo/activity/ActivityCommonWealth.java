...
public class ActivityCommonWealth extends AppCompatActivity implements AdapterView.OnItemClickListener, OnBannerListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.fragment_common_wealth);
                        ...
                        try {
                            ...
                            switch (object.getInt("retcode")) {
                                case 2000:
                                    ...
                                    mFragmentDiscoveryListview.setAdapter(new CommonWealthListviewAdapter(ActivityCommonWealth.this, wealthNewsData.getData()));
                                    break;
                                case 4000:
                                ...
                                case 2000:
                                    switch (object.getInt("retcode")) {
                                        case 2000:
                                            ...
                                            mFragmentDiscoveryGridview02.setAdapter(new CommonWealthGridviewTwoAdapter(ActivityCommonWealth.this, wealthQuestionData.getData()));
                                            break;
                                        case 4000:
    ...
    private void setData() {
        ...
        mFragmentDiscoveryGridview.setAdapter(new DiscoveryAdapter(ActivityCommonWealth.this, discoveryDatas));
...
//                Log.i("dynamictopictitle", "onSuccess: " + response);
                handler.post(new Runnable() {
                    ...
                    public void run() {
                        ...
                        LinearLayoutManager linearLayoutManager = new LinearLayoutManager(ActivityCommonWealth.this);
                        linearLayoutManager.setOrientation(LinearLayoutManager.HORIZONTAL);
                        mFragmentDiscoveryRecyclerview.setLayoutManager(linearLayoutManager);
                        if (data.getRetcode() == 2000) {
                            RecyclerViewDynamicAdapter recyclerAdapter = new RecyclerViewDynamicAdapter(data.getData(), ActivityCommonWealth.this);
                            mFragmentDiscoveryRecyclerview.setAdapter(recyclerAdapter);
                            recyclerAdapter.setHeaderView(View.inflate(ActivityCommonWealth.this, R.layout.item_recycler_header, null));
                            recyclerAdapter.setOnItemClickLitener(new RecyclerViewDynamicAdapter.OnItemClickLitener() {
                                @Override
                                public void onItemClick(View view, int position) {
                                    Intent intent = new Intent(ActivityCommonWealth.this, TopicDetailActivity.class);
...
//                Log.i("commonwealth", "onSuccess: " + response);
                        ...
                        try {
                            ...
                            if (object.getInt("retcode") == 2000) {
                                ...
                                if (data01.getHead_pic().equals("") || data01.getHead_pic().equals("http://59.110.28.150:888/")) {
                                    ...
                                    GlideImgManager.glideLoader(ActivityCommonWealth.this, data01.getHead_pic(), R.mipmap.morentouxiang, R.mipmap.morentouxiang, mCommenWealthIcon01, 0);
                                }
                                if (data02.getHead_pic().equals("") || data02.getHead_pic().equals("http://59.110.28.150:888/")) {
                                    ...
                                    GlideImgManager.glideLoader(ActivityCommonWealth.this, data02.getHead_pic(), R.mipmap.morentouxiang, R.mipmap.morentouxiang, mCommenWealthIcon02, 0);
                                }
                                if (data03.getHead_pic().equals("") || data03.getHead_pic().equals("http://59.110.28.150:888/")) {
                                    ...
                                    GlideImgManager.glideLoader(ActivityCommonWealth.this, data03.getHead_pic(), R.mipmap.morentouxiang, R.mipmap.morentouxiang, mCommenWealthIcon03, 0);
                                }
                                if (data04.getHead_pic().equals("") || data04.getHead_pic().equals("http://59.110.28.150:888/")) {
                                    ...
                                    GlideImgManager.glideLoader(ActivityCommonWealth.this, data04.getHead_pic(), R.mipmap.morentouxiang, R.mipmap.morentouxiang, mCommenWealthIcon04, 0);
                                }
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
        ...
        if (parent == mFragmentDiscoveryGridview) {
            switch (position) {
                case 0:
                    intent = new Intent(ActivityCommonWealth.this, VipWebActivity.class);
                ...
                case 2:
                    ...
                    break;
                case 3:
//                intent = new Intent(ActivityCommonWealth.this, DiscoveryAboutSMActivity.class);
//                startActivity(intent);
                    state = "3";
                    intent = new Intent(ActivityCommonWealth.this, VipWebActivity.class);
                ...
                case 4:
                    state = "2";
                   /* titlename = "关于我们";
                    intent = new Intent(ActivityCommonWealth.this, WebDiscoveryActivity.class);
...
//                startActivity(intent);
                ...
                case 7:
                  ...
                  /*  if (realmobile.equals("")) {
                        intent = new Intent(ActivityCommonWealth.this, BindingMobileActivity.class);
                        intent.putExtra("neworchange", "new");
                        startActivity(intent);
                    } else {
                        intent = new Intent(ActivityCommonWealth.this, ChangeBindingMobileActivity.class);
                    ...
                    break;
                case 8:
                    intent = new Intent(ActivityCommonWealth.this, PhotoRzActivity.class);
                    startActivity(intent);
                    break;
            }
...
//                intent.putExtra("path", "http://hao.shengmo.org:888/Home/Info/news/id/" + wealthNewsData.getData().get(position).getId());
                ...
                intent = new Intent(ActivityCommonWealth.this, DynamicDetailActivity.class);
                ...
                intent = new Intent(ActivityCommonWealth.this, TopicDetailActivity.class);
                ...
                intent = new Intent(ActivityCommonWealth.this, PesonInfoActivity.class);
    ...
    public void onViewClicked(View view) {
        switch (view.getId()) {
            case R.id.mCommenWealth_chat_ll01:
                Intent intent = new Intent(ActivityCommonWealth.this, PesonInfoActivity.class);
                intent.putExtra("uid", markerUid01);
                startActivity(intent);
//                RongOpenConversationUtils.startPrivateChat(ActivityCommonWealth.this, markerUid01, markerNickname01,
//                        new ChatFlagData("0", "0", "0", "0", "0", "0", "0"));
                break;
            case R.id.mCommenWealth_chat_ll02:
//                RongOpenConversationUtils.startPrivateChat(ActivityCommonWealth.this, markerUid02, markerNickname02,
//                        new ChatFlagData("0", "0", "0", "0", "0", "0", "0"));
                 intent = new Intent(ActivityCommonWealth.this, PesonInfoActivity.class);
...
//                RongOpenConversationUtils.startPrivateChat(ActivityCommonWealth.this, markerUid03, markerNickname03,
//                        new ChatFlagData("0", "0", "0", "0", "0", "0", "0"));
                 intent = new Intent(ActivityCommonWealth.this, PesonInfoActivity.class);
...
//                RongOpenConversationUtils.startPrivateChat(ActivityCommonWealth.this, markerUid04, markerNickname04,
//                        new ChatFlagData("0", "0", "0", "0", "0", "0", "0"));
                 intent = new Intent(ActivityCommonWealth.this, PesonInfoActivity.class);
...
//                ContactAlertDialog.openDialog("举报邮箱", mCommenWealthCellphone.getText().toString(), ActivityCommonWealth.this);
                ClipboardManager cm = (ClipboardManager) getSystemService(Context.CLIPBOARD_SERVICE);
                cm.setText(mCommenWealthCellphone.getText().toString());
                ToastUtil.show(ActivityCommonWealth.this.getApplicationContext(), "复制成功");
                break;
            case R.id.mCommenWealth_telephone:
                ContactAlertDialog.openDialog("客服热线", mCommenWealthTelephone.getText().toString(), ActivityCommonWealth.this);
                break;
            case R.id.ll_morenews:
                Intent intent1 = new Intent(this, More_news_Activity.class);
...
//                break;
    ...
    public void OnBannerClick(int position) {
        ...
        if (linkType.get(position).equals("0")) {
            intent = new Intent(ActivityCommonWealth.this, BannerWebActivity.class);
