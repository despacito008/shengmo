        ...
        msfzTijiao.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (real_name.equals("") || real_name == null) {
                    ToastUtil.show(SfzrzActivity.this,"请填写真实姓名");
                    return;
                }
                if (ids.equals("") || ids == null) {
                    ToastUtil.show(SfzrzActivity.this,"请填写身份证号");
                    return;
                }
                if (TextUtil.isEmpty(card_z)) {
                    ToastUtil.show(SfzrzActivity.this,"未检测到身份证正面照，请点击重新上传");
                    return;
                }
                if (TextUtil.isEmpty(card_f)) {
                    ToastUtil.show(SfzrzActivity.this,"未检测到身份证反面照，请点击重新上传");
                    return;
                }
                if (TextUtil.isEmpty(card_hand)) {
                    ToastUtil.show(SfzrzActivity.this,"未检测到手持身份证照，请点击重新上传");
                    return;
                }
