...
public class XiangXiBeiZhuActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_xiang_xi_bei_zhu);
        ...
        mEditNameTijiao.setOnClickListener(new View.OnClickListener() {
            @Override
    ...
    class EditTitleChangedListener implements TextWatcher {
        ...
        public void onTextChanged(CharSequence s, int start, int before, int count) {
            mEditNameCount.setText("(" + s.length() + "/256)");
        }
            ...
            public void onSuccess(String response) {
                ...
                try {
                    ...
                    handler.post(new Runnable() {
                        @Override
                        public void run() {
                            ToastUtil.show(XiangXiBeiZhuActivity.this,""+data.getMsg());
                        }
                    });
                    setResult(200);
                    finish();
