package com.aiwujie.shengmo.utils.emulatorcheck;
...
import static com.aiwujie.shengmo.utils.emulatorcheck.CheckResult.RESULT_EMULATOR;
import static com.aiwujie.shengmo.utils.emulatorcheck.CheckResult.RESULT_MAYBE_EMULATOR;
import static com.aiwujie.shengmo.utils.emulatorcheck.CheckResult.RESULT_UNKNOWN;
...
public class EmulatorCheckUtil {
    ...
    public boolean readSysProperty(Context context, EmulatorCheckCallback callback) {
        ...
        if (userAppNumber > 0 && userAppNumber <= 5) ++suspectCount;
        ...
        //检测电池伏数
        //boolean checkVoltage = checkVoltage(context);
        //if (checkVoltage) ++suspectCount;

        int voltage = getVoltage(context);
...
//                    .append("\r\n").append("voltage == ").append(voltage);
            ...
            StringBuffer stringBuffer = new StringBuffer("")
                    .append("").append("hardware = ").append(hardwareResult.value)
                    .append(",").append("flavor = ").append(flavorResult.value)
                    .append(",").append("model = ").append(modelResult.value)
                    .append(",").append("manufacturer = ").append(manufacturerResult.value)
                    .append(",").append("board = ").append(boardResult.value)
                    .append(",").append("platform = ").append(platformResult.value)
                    .append(",").append("baseBand = ").append(baseBandResult.value)
                    .append(",").append("sensorNumber = ").append(sensorNumber)
                    .append(",").append("userAppNumber = ").append(userAppNumber)
                    .append(",").append("supportCamera = ").append(supportCamera)
                    .append(",").append("supportCameraFlash = ").append(supportCameraFlash)
                    .append(",").append("supportBluetooth = ").append(supportBluetooth)
                    .append(",").append("hasLightSensor = ").append(hasLightSensor)
                    .append(",").append("cgroupResult = ").append(cgroupResult.value)
                    .append(",").append("suspectCount = ").append(suspectCount)
                    .append(",").append("voltage == ").append(voltage);
    ...
    private boolean checkVoltage(Context context) {
        ...
        return voltage == 0 || voltage == 10000;
    }
