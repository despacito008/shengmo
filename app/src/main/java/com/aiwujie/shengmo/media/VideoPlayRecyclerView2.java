 ...
 * 视频播放上下滑动切换控件
 */
public class VideoPlayRecyclerView2 extends FrameLayout {
    private static final int COLOR_BG = Color.BLACK; // 背景色
    private static final float DRAG_RATE = 10f; // 下拉上拉的粘性（数值越大越难下拉）
    ...
    public VideoPlayRecyclerView2(Context context) {
        super(context);
        init();
    }

    public VideoPlayRecyclerView2(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public VideoPlayRecyclerView2(Context context, AttributeSet attrs, int defStyle) {
    ...
    private void init() {
        ...
        //setMaxFlingVelocity(recyclerView,80000);
