 ...
 */
public class EjectionBuyAdapter extends BaseAdapter {
    private Context context;
    private List<StampBuyData.DataBean> list;
    private LayoutInflater inflater;
    public EjectionBuyAdapter(Context context, List<StampBuyData.DataBean> list) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        holder.itemRecorderModou.setText("+"+data.getNum()+"张推顶卡");
        ...
        holder.ivItemBeans.setImageResource(R.drawable.ic_my_push);
        return convertView;
    }
