...
public class MyPresentGridViewAdapter extends BaseAdapter{
    ...
    public MyPresentGridViewAdapter(Context context, List<MyPresentData.DataBean.GiftArrBean> mDatas) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = inflater.inflate(R.layout.item_gridview_present, parent, false);
        ...
        viewHolder.tvName.setText(titles[Integer.parseInt(data.getType())-10]+"x"+data.getNum());
        viewHolder.tvName.setTextColor(Color.parseColor("#333333"));
        viewHolder.tvMoney.setText(moneys[Integer.parseInt(data.getType())-10]);
