...
public class AtRelationShipAdapter extends RecyclerView.Adapter<AtRelationShipAdapter.UserRelationShipHolder> {
    private Context context;
    private List<GzFsHyListviewData.DataBean> userList;
    private String keyWord;
    private boolean isSelf;

    private ArrayList<Atbean.DataBean> selectList;

    public AtRelationShipAdapter(Context context, List<GzFsHyListviewData.DataBean> userList, String keyWord, ArrayList<Atbean.DataBean> selectList) {
    ...
    boolean isContainUser(String uid) {
        ...
        for (Atbean.DataBean bean:selectList) {
