 ...
 */
public class LaudListviewAdapter extends BaseAdapter implements View.OnClickListener {
    private Context context;
    private List<LaudListData.DataBean> list;
    private LayoutInflater inflater;
    Handler handler = new Handler();

    public LaudListviewAdapter(Context context, List<LaudListData.DataBean> list) {
        super();
