 ...
 */
public class InviteSeeAdapter extends BaseAdapter {
    private Context context;
    private List<HomeListviewData.DataBean> list;
    private LayoutInflater inflater;
    private int retcode;

    public InviteSeeAdapter(Context context, List<HomeListviewData.DataBean> list, int retcode) {
        super();
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (retcode == 2000) {
            ...
            holder.itemListviewInviteNearDistance.setText(data.getDistance() + "km");
        ...
        holder.itemListviewInviteNearSign.setText(data.getVisit_time() + "查看");
