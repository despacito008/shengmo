...
public class PushTopUsAdapter extends RecyclerView.Adapter<PushTopUsAdapter.PushTopUsHolder> {
    Context context;
    private List<DynamicDetailBean.DataBean> dataList;

    public PushTopUsAdapter(Context context, List<DynamicDetailBean.DataBean> dataList) {
    ...
    class PushTopUsHolder extends RecyclerView.ViewHolder {
        ...
        public void display(int index) {
            ...
            tvItemPushTopUsTime.setText(timeFormatText);
            tvItemPushTopUsInfo.setText("推顶了你的动态");
