...
import com.aiwujie.shengmo.bean.PayData;
...
public class PayAdapter extends BaseAdapter {
    ...
    private List<PayData.DataBean> list;
    private LayoutInflater inflater;

    public PayAdapter(Context context, List<PayData.DataBean> list) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        PayData.DataBean data=list.get(position);
        ...
        holder.itemRecorderRmb.setText("打赏动态给 ["+data.getFuid()+"]");
        return convertView;
    }
