 ...
 */
public class ChatroomliebiaoListviewAdapter extends BaseAdapter {
    private Context context;
    private List<ChatroomUserListBean.DataBean.UsersBean> list;
    private LayoutInflater inflater;
    Handler handler = new Handler();

    public ChatroomliebiaoListviewAdapter(Context context, List<ChatroomUserListBean.DataBean.UsersBean> list) {
        super();
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        ChatroomUserListBean.DataBean.UsersBean data = list.get(position);
