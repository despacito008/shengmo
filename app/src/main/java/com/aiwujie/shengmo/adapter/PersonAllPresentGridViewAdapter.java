...
public class PersonAllPresentGridViewAdapter extends BaseAdapter {
    ...
    public PersonAllPresentGridViewAdapter(Context context, List<MyPresentData.DataBean.GiftArrBean> mDatas) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = inflater.inflate(R.layout.item_person_gridview_present, parent, false);
        ...
        viewHolder.itemPersonGridviewPresentName.setText(titles[Integer.parseInt(data.getType()) - 10] + "x" + data.getNum());
        viewHolder.itemPersonGridviewPresentDou.setText(moneys[Integer.parseInt(data.getType()) - 10]);
        viewHolder.itemPersonGridviewPresentIv.setImageResource(presents[Integer.parseInt(data.getType()) - 10]);
        return convertView;
    }


    static class ViewHolder {
        @BindView(R.id.item_person_gridview_present_iv)
        ImageView itemPersonGridviewPresentIv;
        @BindView(R.id.item_person_gridview_present_name)
        TextView itemPersonGridviewPresentName;
        @BindView(R.id.item_person_gridview_present_dou)
        TextView itemPersonGridviewPresentDou;
