 ...
 */
public class SearchfriendsListviewAdapter extends BaseAdapter implements View.OnClickListener {
    ...
    public SearchfriendsListviewAdapter(Context context, List<GzFsHyListviewData.DataBean> list, int who, String type) {
        super();
