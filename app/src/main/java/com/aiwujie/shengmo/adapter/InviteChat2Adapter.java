 ...
 */
public class InviteChat2Adapter extends BaseAdapter {
    private Context context;
    private List<ConversationListData> list;
    private LayoutInflater inflater;
    Handler handler = new Handler();

    public InviteChat2Adapter(Context context, List<ConversationListData> list) {
        super();
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (GrouptoaddActivity.inviteUids.contains(data.getUid())){
