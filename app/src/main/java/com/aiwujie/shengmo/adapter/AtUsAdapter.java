...
public class AtUsAdapter extends RecyclerView.Adapter<AtUsAdapter.PushTopUsHolder> {
    Context context;
    private List<AtUserData.DataBean> dataList;

    public AtUsAdapter(Context context, List<AtUserData.DataBean> dataList) {
