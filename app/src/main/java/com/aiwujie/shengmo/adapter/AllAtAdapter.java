 ...
 */
public class AllAtAdapter extends BaseAdapter implements View.OnClickListener {
    private Context context;
    private List<AtUserData.DataBean> list;
    private LayoutInflater inflater;

    public AllAtAdapter(Context context, List<AtUserData.DataBean> list) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        AtUserData.DataBean data = list.get(position);
        ...
        holder.itemListviewAllarguementContent.setText(data.getInfo());
