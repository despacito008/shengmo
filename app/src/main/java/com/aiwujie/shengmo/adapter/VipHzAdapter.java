 ...
 */
public class VipHzAdapter extends BaseAdapter {
    private Context context;
    private List<Frag_VipGmDataBean.DataBean> list;
    private LayoutInflater inflater;

    public VipHzAdapter(Context context, List<Frag_VipGmDataBean.DataBean> list) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        holder.itemRecorderRmb.setText(data.getNickname()+" 赠送我 "+data.getPay_type()+" "+data.getDays()+"天");
