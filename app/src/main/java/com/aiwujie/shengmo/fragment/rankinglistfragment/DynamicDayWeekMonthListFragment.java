...
public class DynamicDayWeekMonthListFragment extends Fragment {
    ...
    public DynamicDayWeekMonthListFragment() {

    }

    public static DynamicDayWeekMonthListFragment newInstance(int State) {
        DynamicDayWeekMonthListFragment newFragment = new DynamicDayWeekMonthListFragment();
