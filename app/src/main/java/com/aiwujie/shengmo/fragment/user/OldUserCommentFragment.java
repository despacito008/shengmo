...
public class OldUserCommentFragment extends Fragment implements PullToRefreshBase.OnRefreshListener2, AdapterView.OnItemClickListener {
...
//    PercentLinearLayout activityPersonInfoComment;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_person_info_comment,container,false);
    ...
    private void setData() {
        ...
        //mPersonInfoCommentTitleName.setText(getActivity().getIntent().getStringExtra("nickname"));
        View view = View.inflate(getActivity(), R.layout.item_person_info_comment_header, null);
...
//                            }
        ...
        if (listData != null) {
            if (listData.getData().size() == 0) {
                if (page != 0) {
                    ...
                    commentAdapter = new AllCommentAdapter(getActivity(), comments);
                    mPersonInfoCommentListview.setAdapter(commentAdapter);
                }
            } else {
                isReresh = true;
                ...
                operateCommentPopup.setOnCommentOperateListener(new OperateCommentPopup.OnCommentOperateListener() {
                    ...
                    public void onCommentReport() {
                        if(comments.get(position).getReportState() == 0) {
                            ...
                            ToastUtil.show(getActivity(),"该条评论已经举报过");
                        }
                    }
    ...
    public void onPullDownToRefresh(PullToRefreshBase refreshView) {
        ...
        refresh = new TimeSecondUtils(getActivity(), mPersonInfoCommentListview);
        handler.postDelayed(new Runnable() {
            @Override
            public void run() {
                getCommentList();
