...
public class CommentOhterDayWeekMonthListFragment extends Fragment {
    ...
    public CommentOhterDayWeekMonthListFragment() {

    }

    public static CommentOhterDayWeekMonthListFragment newInstance(int State) {
        CommentOhterDayWeekMonthListFragment newFragment = new CommentOhterDayWeekMonthListFragment();
    ...
    private void getBeLaudedRankingList() {
        ...
        manager.post(HttpUrl.GetCommentRankingList, map, new IRequestCallback() {
            @Override
