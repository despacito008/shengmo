...
public class CommentDayWeekMonthListFragment extends Fragment {
    ...
    public CommentDayWeekMonthListFragment() {

    }

    public static CommentDayWeekMonthListFragment newInstance(int State) {
        CommentDayWeekMonthListFragment newFragment = new CommentDayWeekMonthListFragment();
    ...
    private void getBeLaudedRankingList() {
        ...
        manager.post(HttpUrl.GetBeCommentedRankingList, map, new IRequestCallback() {
            @Override
            public void onSuccess(final String response) {
                Log.i("dayweekmonthlist11111", "run: "+response);
