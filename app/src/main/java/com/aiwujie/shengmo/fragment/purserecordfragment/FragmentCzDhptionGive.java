...
import com.aiwujie.shengmo.CzCzDhGiveAdapter;
 ...
 */
public class FragmentCzDhptionGive extends Fragment implements PullToRefreshBase.OnRefreshListener2 {
    ...
    private CzCzDhGiveAdapter listviewAdapter;
                        ...
                        try {
                            ...
                            if (listData.getData().size() == 0) {
                                ...
                                if (page == 0) {
                                    ...
                                    try {
                                        listviewAdapter = new CzCzDhGiveAdapter(getActivity(), bills);
