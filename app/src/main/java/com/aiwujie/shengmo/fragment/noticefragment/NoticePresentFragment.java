...
import com.aiwujie.shengmo.adapter.PresentListAdapter;
...
public class NoticePresentFragment extends Fragment implements PullToRefreshBase.OnRefreshListener2{
    ...
    List<NoticePresentData.DataBean> noticePresentDatas=new ArrayList<>();
    private PresentListAdapter listAdapter;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        viewById.setText("送500魔豆以上的礼物可上大喇叭");
        isPrepared = true;
        lazyLoad();
        return view;
    }
        ...
        manager.post(HttpUrl.GetPresentMsg, map, new IRequestCallback() {
            ...
            public void onSuccess(final String response) {
                ...
                handler.post(new Runnable() {
                    ...
                    public void run() {
                        try{
                            NoticePresentData listData = new Gson().fromJson(response, NoticePresentData.class);
                            if (listData.getData().size() == 0) {
                                ...
                                if (page == 0) {
                                    ...
                                    try {
                                        listAdapter = new PresentListAdapter(getActivity(), noticePresentDatas);
    ...
    public void onPullDownToRefresh(PullToRefreshBase refreshView) {
        ...
        EventBus.getDefault().post("zengsongliwuredmei1");
        handler.postDelayed(new Runnable() {
            @Override
            public void run() {
                EventBus.getDefault().post("zengsongliwuredmei");
            }
        },3000);
