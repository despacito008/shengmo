...
import com.aiwujie.shengmo.adapter.WarningAdapter2;
...
public class BanUserFragment extends Fragment implements AdapterView.OnItemClickListener ,PullToRefreshBase.OnRefreshListener2{
    ...
    private WarningAdapter2 warningAdapter;
                        ...
                        try {
                            ...
                            if (listData.getData().size() == 0) {
                                ...
                                if (page == 0) {
                                    ...
                                    try {
                                        warningAdapter = new WarningAdapter2(getActivity(), warnings,true);
