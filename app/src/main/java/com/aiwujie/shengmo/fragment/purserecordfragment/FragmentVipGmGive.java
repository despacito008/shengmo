...
import com.aiwujie.shengmo.adapter.VipGmAdapter;
 ...
 */
public class FragmentVipGmGive extends Fragment implements PullToRefreshBase.OnRefreshListener2 {
    ...
    private VipGmAdapter listviewAdapter;
...
//        setListener();
    ...
    private void getBills() {
        ...
        manager.post(HttpUrl.vipbuylist, map, new IRequestCallback() {
            @Override
                        ...
                        try {
                            ...
                            if (listData.getData().size() == 0) {
                                ...
                                if (page == 0) {
                                    ...
                                    try {
                                        listviewAdapter = new VipGmAdapter(getActivity(), bills);
