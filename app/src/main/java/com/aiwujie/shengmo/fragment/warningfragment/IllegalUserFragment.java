...
public class IllegalUserFragment extends Fragment implements AdapterView.OnItemClickListener ,PullToRefreshBase.OnRefreshListener2{
                        ...
                        try {
                            ...
                            if (listData.getData().size() == 0) {
                                ...
                                if (page == 0) {
                                    ...
                                    try {
                                        warningAdapter = new WarningAdapter(getActivity(), warnings,true);
