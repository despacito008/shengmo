 ...
 */
public class TaRenEjectionStampUse extends Fragment implements PullToRefreshBase.OnRefreshListener2 ,AdapterView.OnItemClickListener{
    ...
    private TopcardCommentAdapter listviewAdapter;
...
//        setListener();
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
        ...
        intent.putExtra("uid", bills.get(position).getUid());
        intent.putExtra("did", bills.get(position).getDid());
                        ...
                        try {
                            ...
                            if (listData.getData().size() == 0) {
                                ...
                                if (page == 0) {
                                    ...
                                    try {
                                        listviewAdapter = new TopcardCommentAdapter(getActivity(), bills);
