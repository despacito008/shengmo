...
public class SvipFragment extends Fragment {

    @BindView(R.id.rv_fragment_svip)
    RecyclerView rvFragmentSvip;
    Unbinder unbinder;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.app_fragment_svip, container, false);
    ...
    void getData() {
        HttpHelper.getInstance().getVipGoodsList("1", new HttpListener() {
            @Override
            public void onSuccess(String data) {
                ...
                rvFragmentSvip.setAdapter(vipGoodsRecyclerAdapter);
                rvFragmentSvip.setLayoutManager(gridLayoutManager);
...
//        addData("1", "1个月", "31天超值特权", "128", "", "");
//        addData("2", "3个月", "93天超值特权", "348", "384", "9");
//        addData("3", "6个月", "186天超值特权", "898", "1024", "13");
//        addData("4", "12个月", "372天超值特权", "1298", "1536", "16");
