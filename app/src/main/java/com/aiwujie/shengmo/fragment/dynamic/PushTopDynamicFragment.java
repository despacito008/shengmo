...
public class PushTopDynamicFragment extends Fragment {
    ...
    public static PushTopDynamicFragment newInstance() {
        Bundle args = new Bundle();
        PushTopDynamicFragment fragment = new PushTopDynamicFragment();
    ...
    void getDynamicList() {
        HttpHelper.getInstance().getDynamicList("5", "", "", order, lastId, page, new HttpListener() {
            @Override
            public void onSuccess(String data) {
                ...
                if (page == 0) {
                    ...
                    dynamicRecyclerAdapter = new DynamicRecyclerAdapter(getActivity(), dynamicList, dynamicData.getRetcode(), "5");
    ...
    public void changeOrder(int type) {
        ...
        if (srlFragmentDynamicPushTop != null) {
