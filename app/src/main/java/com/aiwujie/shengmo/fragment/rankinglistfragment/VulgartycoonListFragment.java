...
/**
 * Created by 290243232 on 2017/5/10.
 */

public class VulgartycoonListFragment extends Fragment {
    ...
    private void setData() {
        ...
        for (int i = 0; i < mTitleList.size()-1; i++) {
            mViewList.add(VulgarWealthDayWeekMonthListFragment.newInstance(i));
        }
        mViewList.add(new RegalTotalListFragment());
        ...
        itemFragmentRankViewpager.setOffscreenPageLimit(3);
