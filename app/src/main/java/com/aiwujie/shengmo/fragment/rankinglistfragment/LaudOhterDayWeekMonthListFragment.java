...
public class LaudOhterDayWeekMonthListFragment extends Fragment {
    ...
    public LaudOhterDayWeekMonthListFragment() {

    }

    public static LaudOhterDayWeekMonthListFragment newInstance(int State) {
        LaudOhterDayWeekMonthListFragment newFragment = new LaudOhterDayWeekMonthListFragment();
    ...
    private void getBeLaudedRankingList() {
        ...
        manager.post(HttpUrl.GetLaudRankingList, map, new IRequestCallback() {
            @Override
