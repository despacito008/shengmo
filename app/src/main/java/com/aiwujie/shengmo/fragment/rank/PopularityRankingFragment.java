...
public class PopularityRankingFragment extends CommonLazyLoadFragment {
    ...
    public static PopularityRankingFragment newInstance(String popType, String type) {
        Bundle args = new Bundle();
        args.putString("type", type);
        args.putString("popType", popType);
        PopularityRankingFragment fragment = new PopularityRankingFragment();
...
//    }
    ...
    protected int providelayoutId() {
        return R.layout.app_fragment_popularity_ranking;
    }
    ...
    void getCharmRanking() {
        isLoading = true;
        HttpHelper.getInstance().getPopularityRankingList(popType, type, page, new HttpListener() {
            @Override
...
//                List<RankBerewardData.DataBean> rankRewardList = rankBerewardData.getData();
    ...
    void initRankingRecyclerView(List<RankPopularityData.DataBean> rankRewardList) {
        ...
        popularityRankRecyclerAdapter = new PopularityRankRecyclerAdapter(getActivity(), rankList);
