 ...
 */
public class FragmentGroupNew extends Fragment implements AdapterView.OnItemClickListener, PullToRefreshBase.OnRefreshListener2 {
    @BindView(R.id.mFragment_group_new_listview)
    PullToRefreshListView mFragmentGroupNewListview;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.item_fragment_group_new, null);
...
//        setListener();
    ...
    private void setData() {
        mFragmentGroupNewListview.setMode(PullToRefreshBase.Mode.PULL_FROM_START);
        //实现自动刷新
        handler.postDelayed(new Runnable() {
            @Override
            public void run() {
                mFragmentGroupNewListview.setRefreshing();
            }
        }, 100);
    ...
    private void setListener() {
        mFragmentGroupNewListview.setOnRefreshListener(this);
        mFragmentGroupNewListview.setOnItemClickListener(this);
        mFragmentGroupNewListview.getRefreshableView().setOnScrollListener(new AbsListView.OnScrollListener() {
            @Override
    ...
    private void getGroupList() {
        ...
        manager.post(HttpUrl.GetGroupListFilter, map, new IRequestCallback() {
            ...
            public void onSuccess(final String response) {
                    ...
                    if (listData.getData().size() == 0) {
                        ...
                        if (page == 0) {
                            ...
                            try {
                                ...
                                mFragmentGroupNewListview.setAdapter(groupAdapter);
                ...
                mFragmentGroupNewListview.onRefreshComplete();
                if (refresh != null) {
                    refresh.cancel();
                }
                EventBus.getDefault().post(new ClearRedPointEvent("clearGroupRedPoint", 5));
            }
    ...
    public void onPullDownToRefresh(PullToRefreshBase refreshView) {
        ...
        refresh = new TimeSecondUtils(getActivity(), mFragmentGroupNewListview);
        handler.postDelayed(new Runnable() {
            @Override
            public void run() {
                getGroupList();
