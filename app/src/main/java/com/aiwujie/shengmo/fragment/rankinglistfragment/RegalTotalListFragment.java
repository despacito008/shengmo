...
import com.aiwujie.shengmo.adapter.RankRegalAdapter;
...
public class RegalTotalListFragment extends Fragment {

    @BindView(R.id.item_fragment_fragment_rank_listview)
    ListView itemFragmentFragmentRankListview;
    private int page=0;
    private List<RankRegalData.DataBean> ranks=new ArrayList<>();
    ...
    private RankRegalAdapter ranksAdapter;
        ...
        manager.post(HttpUrl.GetGiftAllList, map, new IRequestCallback() {
            ...
            public void onSuccess(final String response) {
                ...
                handler.post(new Runnable() {
                    ...
                    public void run() {
                        try {
                            RankRegalData data = new Gson().fromJson(response, RankRegalData.class);
                                if (data.getData().size() == 0) {
                                    ...
                                    if (page == 0) {
                                        ...
                                        ranksAdapter = new RankRegalAdapter(getActivity(), ranks);
