...
import com.aiwujie.shengmo.adapter.VipHzAdapter;
 ...
 */
public class FragmentVipHzGive extends Fragment implements PullToRefreshBase.OnRefreshListener2 {
    ...
    private int page = 0;
    List<Frag_VipGmDataBean.DataBean> bills = new ArrayList<>();
    Handler handler = new Handler();
    private VipHzAdapter listviewAdapter;
...
//        setListener();
    ...
    private void getBills() {
        ...
        manager.post(HttpUrl.vipgiftlist, map, new IRequestCallback() {
            @Override
            public void onSuccess(final String response) {
                handler.post(new Runnable() {
                    ...
                    public void run() {
                        try {
                            Frag_VipGmDataBean listData = new Gson().fromJson(response, Frag_VipGmDataBean.class);
                            if (listData.getData().size() == 0) {
                                ...
                                if (page == 0) {
                                    ...
                                    try {
                                        listviewAdapter = new VipHzAdapter(getActivity(), bills);
