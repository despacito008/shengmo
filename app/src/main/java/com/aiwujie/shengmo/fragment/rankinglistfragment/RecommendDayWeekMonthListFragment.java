...
public class RecommendDayWeekMonthListFragment extends Fragment {
    ...
    public RecommendDayWeekMonthListFragment() {

    }

    public static RecommendDayWeekMonthListFragment newInstance(int State) {
        RecommendDayWeekMonthListFragment newFragment = new RecommendDayWeekMonthListFragment();
    ...
    private void getBeLaudedRankingList() {
        ...
        manager.post(HttpUrl.GetSendDynamicRandkingList, map, new IRequestCallback() {
            @Override
