...
import com.aiwujie.shengmo.kt.ui.fragment.RechargeGiveFragment;
...
public class FragmentConsumption extends Fragment {
    ...
    private void setData() {
        ...
        mTitleList.add("兑换");
        //添加页卡视图
        //mViewList.add(new FragmentConsumptionGive());
        mViewList.add(new RechargeGiveFragment());
        mViewList.add(ExchangeRecordDetailsFragment.Companion.newInstance(0));
        //mViewList.add(new RechargeExchangeFragment());
