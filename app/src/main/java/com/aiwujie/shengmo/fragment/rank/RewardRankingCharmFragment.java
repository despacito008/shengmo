...
import com.aiwujie.shengmo.adapter.RankCharmAdapter;
...
public class RewardRankingCharmFragment extends CommonLazyLoadFragment {
    ...
    public static RewardRankingCharmFragment newInstance(String type) {
        Bundle args = new Bundle();
        args.putString("type", type);
        RewardRankingCharmFragment fragment = new RewardRankingCharmFragment();
...
//        View view = inflater.inflate(R.layout.app_fragment_reward_ranking_charm, container, false);
//
//        getData();
//        return view;
//    }
    ...
    protected int providelayoutId() {
        return R.layout.app_fragment_reward_ranking_charm;
    }
    ...
    void getCharmRanking() {
        isLoading = true;
        HttpHelper.getInstance().getRewardCharmRankingList(type, page, new HttpListener() {
            @Override
            public void onSuccess(String data) {
                ...
                if(page == 0) {
                    ...
                    if(rankRewardList != null && rankRewardList.size() > 0) {
                        ...
                        rewardRankRecyclerAdapter.notifyItemRangeChanged(temp-1,rankList.size());
                    } else {
                        hasMore = false;
                    }
                }
    ...
    void initTop3View(List<RankBerewardData.DataBean> rankRewardList) {
        ...
        if (rankRewardList.size() >= 1) {
            ...
            tvFragmentRewardRankingWealthTopOneSendCount.setText("收到" + rankBean.getAllamount());
            ...
            if (rankBean.getRewardeduserinfo() != null) {
        ...
        if (rankRewardList.size() >= 2) {
            ...
            tvFragmentRewardRankingWealthTopTwoSendCount.setText("收到" + rankBean.getAllamount());
        ...
        if (rankRewardList.size() >= 3) {
            ...
            tvFragmentRewardRankingWealthTopThreeSendCount.setText("收到" + rankBean.getAllamount());
    ...
    void initRankingRecyclerView(List<RankBerewardData.DataBean> rankRewardList) {
        ...
        rewardRankRecyclerAdapter = new RewardRankRecyclerAdapter(getActivity(), rankList, 2);
    ...
    void initListener(final List<RankBerewardData.DataBean> rankRewardList) {
        ...
        llFragmentRewardRankingWealthTopOneFavour.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if(!TextUtil.isEmpty(rankRewardList.get(0).getRewardeduserinfo().getUid())) {
                    gotoUserInfoActivity(rankRewardList.get(0).getRewardeduserinfo().getUid());
                } else {
        ...
        llFragmentRewardRankingWealthTopTwoFavour.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if(!TextUtil.isEmpty(rankRewardList.get(1).getRewardeduserinfo().getUid())) {
                    gotoUserInfoActivity(rankRewardList.get(1).getRewardeduserinfo().getUid());
                } else {
