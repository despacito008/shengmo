...
import com.aiwujie.shengmo.adapter.StampUseAdapter;
 ...
 */
public class FragmentStampUse extends Fragment implements PullToRefreshBase.OnRefreshListener2 {
    ...
    private int page = 0;
    List<StampUseData.DataBean> bills = new ArrayList<>();
    Handler handler = new Handler();
    private StampUseAdapter listviewAdapter;
...
//        setListener();
    ...
    private void getBills() {
        ...
        manager.post(HttpUrl.GetStampUsedRs, map, new IRequestCallback() {
            @Override
            public void onSuccess(final String response) {
                handler.post(new Runnable() {
                    ...
                    public void run() {
                        try {
                            StampUseData listData = new Gson().fromJson(response, StampUseData.class);
                            if (listData.getData().size() == 0) {
                                ...
                                if (page == 0) {
                                    ...
                                    try {
                                        listviewAdapter = new StampUseAdapter(getActivity(), bills);
