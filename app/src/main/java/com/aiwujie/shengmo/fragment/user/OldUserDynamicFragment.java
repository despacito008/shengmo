...
public class OldUserDynamicFragment extends Fragment implements View.OnTouchListener, PullToRefreshBase.OnRefreshListener2, View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_person_info_dynamic,container,false);
    ...
    private void setData() {
        ...
        //mPersonInfoDynamicTitleName.setText(getActivity().getIntent().getStringExtra("nickname"));
        View view = View.inflate(getActivity(), R.layout.item_person_info_dynamic_header, null);
...
//                                        mPersonInfoDynamicBottomTv.setText(clickUtils.addClickablePart("互为好友、VIP会员","TA的动态限","可见"), TextView.BufferType.SPANNABLE);
        ...
        if (listData != null) {
            if (listData.getData().size() == 0) {
                if (page != 0) {
                    ...
                    dynamicAdapter = new DynamicPersonMsgListviewAdapter(getActivity(), dynamics, 0,"3");
                    mPersonInfoDynamicListview.setAdapter(dynamicAdapter);
                }
            } else {
                isReresh = true;
                if (page == 0) {
                    ...
                    try {
                        dynamicAdapter = new DynamicPersonMsgListviewAdapter(getActivity(), dynamics, retcode,"3");
                        mPersonInfoDynamicListview.setAdapter(dynamicAdapter);
    ...
    public void onPullDownToRefresh(PullToRefreshBase refreshView) {
        ...
        refresh = new TimeSecondUtils(getActivity(), mPersonInfoDynamicListview);
        handler.postDelayed(new Runnable() {
            @Override
            public void run() {
                lastid = "";
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.mPersonInfo_dynamic_ll_joinTopic:
                Intent intent = new Intent(getActivity(), MyOrOtherTopicActivity.class);
