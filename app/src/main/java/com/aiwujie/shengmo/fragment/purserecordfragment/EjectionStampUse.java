...
import com.aiwujie.shengmo.adapter.ShiyongTopcardAdapter;
 ...
 */
public class EjectionStampUse extends Fragment implements PullToRefreshBase.OnRefreshListener2 ,AdapterView.OnItemClickListener{
    ...
    private int page = 0;
    List<DynamicDetailBean.DataBean> bills = new ArrayList<>();
    Handler handler = new Handler();
    private ShiyongTopcardAdapter listviewAdapter;
...
//        setListener();
        isPrepared = true;
        lazyLoad();
        mFragmentWithdrawalsListview.setOnItemClickListener(this);
        return view;
    }
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
        ...
        intent.putExtra("uid", bills.get(position-1).getUid());
        intent.putExtra("did", bills.get(position-1).getDid());
                        ...
                        try {
                            ...
                            if (listData.getData().size() == 0) {
                                ...
                                if (page == 0) {
                                    ...
                                    try {
                                        listviewAdapter = new ShiyongTopcardAdapter(getActivity(), bills);
