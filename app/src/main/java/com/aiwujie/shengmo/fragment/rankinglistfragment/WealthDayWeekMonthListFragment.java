...
import com.aiwujie.shengmo.adapter.RankRewardTwoAdapter;
 ...
 */
//魅力榜
public class WealthDayWeekMonthListFragment extends Fragment {
    ...
    List<RankRegalTowData.DataBean> ranks=new ArrayList<>();
    private RankRewardTwoAdapter ranksAdapter;

    public WealthDayWeekMonthListFragment() {

    }

    public static WealthDayWeekMonthListFragment newInstance(int State) {
        WealthDayWeekMonthListFragment newFragment = new WealthDayWeekMonthListFragment();
    ...
    private void getBeLaudedRankingList() {
        ...
        manager.post(HttpUrl.GetCharmRankingList, map, new IRequestCallback() {
            @Override
            public void onSuccess(final String response) {
                ...
                handler.post(new Runnable() {
                    ...
                    public void run() {
                        try {
                            RankRegalTowData data = new Gson().fromJson(response, RankRegalTowData.class);
                            if(data.getData().size()==0){
                                ...
                                if (page == 0) {
                                    ...
                                    ranksAdapter = new RankRewardTwoAdapter(getActivity(),ranks);
