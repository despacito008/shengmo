...
import com.aiwujie.shengmo.adapter.StampBuyAdapter;
 ...
 */
public class FragmentStampBuy extends Fragment implements PullToRefreshBase.OnRefreshListener2 {
    ...
    private StampBuyAdapter listviewAdapter;
...
//        setListener();
    ...
    private void getBills() {
        ...
        manager.post(HttpUrl.GetStampPaymentRs, map, new IRequestCallback() {
            @Override
                        ...
                        try {
                            ...
                            if (listData.getData().size() == 0) {
                                ...
                                if (page == 0) {
                                    ...
                                    try {
                                        listviewAdapter = new StampBuyAdapter(getActivity(), bills);
