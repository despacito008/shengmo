 ...
 * 用于展示房间列表的item
 */
public class LiveLogListAdapter2 extends RecyclerView.Adapter<LiveLogListAdapter2.ViewHolder> {

    private Context mContext;
    private List<LiveLogBean.DataBean> mList;
    String type = "";
    private String mCurrentPlayBackId = "-1";

    public LiveLogListAdapter2(Context context, List<LiveLogBean.DataBean> list) {
        this.mContext = context;
        this.mList = list;
    }

    public LiveLogListAdapter2(Context context, List<LiveLogBean.DataBean> list,String currentPlayBackId) {
        this.mContext = context;
        this.mList = list;
        this.mCurrentPlayBackId = currentPlayBackId;
    }

    @Override
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(mContext).inflate(R.layout.app_item_live_log2, parent, false);
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        private void initView(@NonNull final View itemView) {
            ...
            mFrontGroundView = itemView.findViewById(R.id.view_front_ground);
        }
...
//            }
            ...
            LogUtil.d(roomInfo.getId() + "----" + mCurrentPlayBackId);
            if (roomInfo.getId().equals(mCurrentPlayBackId)) {
                mFrontGroundView.setVisibility(View.VISIBLE);
            } else {
                mFrontGroundView.setVisibility(View.GONE);
            }
        }
    }
    ...
    public void updateChooseId(String id) {
        mCurrentPlayBackId = id;
    }
}
