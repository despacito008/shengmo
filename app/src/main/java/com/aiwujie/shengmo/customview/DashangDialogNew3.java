 ...
 */
public class DashangDialogNew3 extends AlertDialog implements TextWatcher, View.OnClickListener {
    ...
    private String[] titles = {"棒棒糖", "狗粮", "雪糕", "黄瓜", "心心相印", "香蕉", "口红", "亲一个", "玫瑰花", "眼罩",
            ...
            "跑车", "直升机", "游轮", "城堡"};
    private String[] titles2 = {"棒棒糖", "狗粮", "雪糕", "黄瓜", "心心相印", "香蕉", "口红", "亲一个", "玫瑰花", "眼罩",
            "心灵束缚", "黄金", "拍之印", "鞭之痕", "一飞冲天", "一生一世", "水晶高跟", "恒之光", "666", "红酒", "蛋糕", "钻戒", "皇冠",
    ...
    public DashangDialogNew3(final Context context, String fuid) {
        super(context);
    ...
    public DashangDialogNew3(final Context context, String dmid, int pos, String rewardcount, String uid) {
        super(context);
        this.context = context;
        this.dmid = dmid;
        this.pos = pos;
...
//                                                psid = (int) (Integer.parseInt(data.getData().get((int) id).getType()));
    ...
    private void alertdialog() {
        ...
        Date date = new Date();
        long l = date.getTime();
        orderid = MyApp.uid + SystemClock.currentThreadTimeMillis();
...
//        dialog.show();
    ...
    private JSONObject getRewardObj() {
        ...
        try {
            if (fuid == null) {
                ...
                rewardObj.put("uid", MyApp.uid);
                rewardObj.put("orderid", orderid);
                rewardObj.put("groupid", uid);
            ...
            try {
                ...
                if (fuid == null) {
                    ...
                    if (buyOrSystemFlg == 0) {
                        ...
                        switch (obj.getString("retcode")) {
                            case "2000":
                                sendPhone(titles2[psid - 10] + "", etCount.getText().toString() + "");
                                //ToastUtil.show(getContext().getApplicationContext(), obj.getString("msg"));
    ...
    public void sendPhone(final String imageName, final String number) {

//        final Message_Group_LiWu info =new Message_Group_LiWu();
...
//        });
        ...
        V2TIMManager.getGroupManager().getGroupMembersInfo(fuid, members, new V2TIMValueCallback<List<V2TIMGroupMemberFullInfo>>() {
            @Override
            public void onError(int code, String desc) {
                MessageSendHelper.getInstance().sendTipMessage("你给大家送了礼物", "ta给大家打赏了礼物");
                MessageSendHelper.getInstance().sendGiftMessage(imageName, number, orderid);
            }

            @Override
            public void onSuccess(List<V2TIMGroupMemberFullInfo> v2TIMGroupMemberFullInfos) {
                String name = v2TIMGroupMemberFullInfos.get(0).getNickName();
