 ...
 */
public class DashangDialogNew4 extends AlertDialog implements TextWatcher, View.OnClickListener {
    ...
    String dalaba="2";
    int zongdoudoushu;
    private com.zhy.android.percent.support.PercentLinearLayout duoxufanya;

    public DashangDialogNew4(final Context context, String fuid) {
        super(context);
    ...
    public DashangDialogNew4(final Context context, String dmid, int pos, String rewardcount, String uid) {
        super(context);
        this.context = context;
        this.dmid = dmid;
        this.pos = pos;
...
//                                                psid = (int) (Integer.parseInt(data.getData().get((int) id).getType()));
    ...
    public void sendPhone(String imageName,String number,String chatUserid){
