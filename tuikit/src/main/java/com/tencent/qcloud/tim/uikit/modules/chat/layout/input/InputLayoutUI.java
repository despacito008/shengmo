...
//        mShortcutArea = findViewById(R.id.shortcut_area);
    ...
    protected List<InputMoreActionUnit> assembleActions() {
        ...
        if(prepareListener != null) {
            prepareListener.OnActionPrepare();
        }
        return mInputMoreActionList;
    }
    ...
    public List<InputMoreActionUnit> getAction() {
        return mInputMoreActionList;
    }
    ...
    public interface OnActionPrepareListener {
        void OnActionPrepare();
    }

    public OnActionPrepareListener prepareListener;

    public void setPrepareListener(OnActionPrepareListener prepareListener) {
