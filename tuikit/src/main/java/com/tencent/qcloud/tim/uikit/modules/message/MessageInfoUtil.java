...
public class MessageInfoUtil {
    ...
    public static MessageInfo buildImageMessage2(final Uri uri, boolean compressed) {
        final MessageInfo info = new MessageInfo();
    ...
    private static MessageInfo createGroupTipsMessageInfo(V2TIMMessage timMessage, Context context) {
        ...
        if (groupTipElem.getMemberList().size() > 0) {
            ...
            for (int i = 0; i < v2TIMGroupMemberInfoList.size(); i++) {
                ...
                if (i == 0) {
                    ...
                    if (TextUtils.isEmpty(v2TIMGroupMemberInfo.getNickName())) {
                        ...
                        user = user + v2TIMGroupMemberInfo.getNickName();
                    }
                } else {
            ...
            if (TextUtils.isEmpty(groupTipElem.getOpMember().getNickName())) {
                user = groupTipElem.getOpMember().getUserID();
            } else {
                user = groupTipElem.getOpMember().getNickName();
            }
        }
