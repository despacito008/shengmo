...
public class ConversationListAdapter extends IConversationAdapter {
    ...
    private ConversationListLayout.onItemIconClickListener mOnItemIconClickListener;
    ...
    public ConversationListAdapter(boolean hideSearchBar) {
    ...
    public void setOnItemIconClickListener( ConversationListLayout.onItemIconClickListener listener) {
        this.mOnItemIconClickListener = listener;
    }
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        if (viewType == ITEM_TYPE_HEADER_SEARCH) {
            if (hideSearchBar) {
                searchView = LayoutInflater.from(parent.getContext()).inflate(R.layout.conversation_search_hide, parent, false);
            } else {
                searchView = LayoutInflater.from(parent.getContext()).inflate(R.layout.conversation_search_adapter, parent, false);
            }
            Log.d("logutil","searchView init");
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, final int position) {
        ...
        switch (getItemViewType(position)) {
            ...
            default:
                ...
                if (mOnItemIconClickListener != null) {
                    View view = holder.itemView.findViewById(R.id.conversation_icon);
                    if (view != null) {
                        view.setOnClickListener(new View.OnClickListener() {
                            @Override
                            public void onClick(View view) {
                                mOnItemIconClickListener.onItemIconClick(view, position, conversationInfo);
                            }
                        });
                    }
                }
