...
public class GiftBulletFrameLayout extends FrameLayout implements Handler.Callback {
    ...
    private void initView() {
        ...
        mTextCount = (TextView) mRootView.findViewById(R.id.tv_count);
    ...
    public boolean setGift(GiftInfo gift) {
        ...
        if (!TextUtils.isEmpty(gift.title)) {
            ...
            mTextGiftTitle.setText(gift.title);
        }
        if(gift.count > 1){
            mTextCount.setText("x" + gift.count + " ");
        }
        return true;
    }
...
//        AnimationUtils.startAnimation(giftLayoutAnimator);
