...
public class FloatWindowLayout2 extends ConstraintLayout {
    ...
    private FloatWindowLayout2.FloatWindowLayoutDelegate mFloatWindowLayoutDelegate;
    ...
    public static synchronized FloatWindowLayout2 getInstance() {
        if (sInstance == null) {
            sInstance = new FloatWindowLayout2(TUIKitLive.getAppContext());
        }
        return sInstance;
    }

    public FloatWindowLayout2(Context context) {
        super(context);
        initView(context);
    }

    public void setFloatWindowLayoutDelegate(FloatWindowLayout2.FloatWindowLayoutDelegate floatWindowLayoutDelegate) {
    ...
    private void initView(Context context) {
        mContext = context;
        mViewRoot = inflate(context, R.layout.alert_float_screen_layout, this);
        initFloatWindowParams();
    }

    public boolean showFloatWindow(View view, FloatWindowLayout2.IntentParams intentParam) {
...
//            Constents.isShowAudienceFloatWindow = true;
    ...
    public boolean closeFloatWindowWithoutDestroy() {
        if (!Config.enableFloatWindow()) {
            return false;
        }
    ...
    private void initFloatWindowParams() {
        ...
        FloatWindowLayout2.FloatWindowRect rect = new FloatWindowLayout2.FloatWindowRect(screenWidth - 240, 0, 240, 360);
        minX = -(rect.x / 2);
        maxX = (rect.x / 2);
    ...
    private void startActivity() {
        if (mIntentParams != null) {
            ...
            Intent intent = new Intent(FloatWindowLayout2.this.getContext(), mIntentParams.activityClass);
