...
public class LiveVideoView extends RelativeLayout {
    ...
    private void initView(Context context) {
        ...
        mPlayerVideo.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
                if (onLiveViewClickListener != null) {
                    onLiveViewClickListener.onLiveViewClick(LiveVideoView.this.userId);
                }
            }
        });
    }
...
//        mImageLoading.setImageResource(R.drawable.trtcliveroom_linkmic_loading);
    ...
    public interface OnLiveViewClickListener {
        void onLiveViewClick(String uid);
    }
    public OnLiveViewClickListener onLiveViewClickListener;

    public void setOnLiveViewClickListener(OnLiveViewClickListener onLiveViewClickListener) {
        this.onLiveViewClickListener = onLiveViewClickListener;
    }
}
