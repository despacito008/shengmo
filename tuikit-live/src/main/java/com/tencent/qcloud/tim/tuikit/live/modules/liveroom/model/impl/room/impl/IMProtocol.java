...
public class IMProtocol {
    ...
    public static String getCusMessage(String text,String live_group_role,int live_user_role) {
        JSONObject jsonObject = new JSONObject();
        try {
    ...
    //客户端发送自定义文本消息
    public static String getCusMessage(ChatEntity entity) {
        JSONObject jsonObject = new JSONObject();
        try {
            ...
            jsonObject.put("background_color",entity.getBackground_color());
            jsonObject.put("fanclub_level",entity.getFanclub_level());
            jsonObject.put("fanclub_card",entity.getFanclub_card());
            jsonObject.put("fanclub_status",entity.getFanclub_status());
        } catch (JSONException e) {
            e.printStackTrace();
        }
        return jsonObject.toString();
