...
public abstract class TRTCLiveRoom {
     ...
     *
     * @param userId   需要观看的用户id
     * @param flvUrl   推荐，秒开效果好，支持超高并发。
     * @param view     承载视频画面的 view 控件
     * @param callback 操作回调
     */
    public abstract void startPlay(String userId, String flvUrl,TXCloudVideoView view, TRTCLiveRoomCallback.ActionCallback callback);
