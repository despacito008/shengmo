...
public class Constants {
    ...
    public static final String PUSHER_ADDRESS = "push_address";
     ...
     */
    public static final int TEXT_TYPE                 = 0;   //普通消息
    public static final int MEMBER_ENTER              = 1;   //进入房间消息
    public static final int MEMBER_EXIT               = 2;   //退出房间消息
    ...
    public static final int REQUEST_LINK_MIC_TIME_OUT = 20;  // 请求 连麦/PK 的超时时间
