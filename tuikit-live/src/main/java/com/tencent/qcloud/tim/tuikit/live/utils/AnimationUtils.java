...
public class AnimationUtils {
     ...
     */
    public static ObjectAnimator createFadesInFromRtoL(final View target, float star, float end,
                                                       int duration, TimeInterpolator interpolator) {
        ObjectAnimator animator = ObjectAnimator.ofFloat(target, "translationX",
                star, end);
        animator.setInterpolator(interpolator);
    ...
    public static AnimatorSet startAnimation(ObjectAnimator animatorFirst) {
        AnimatorSet animSet = new AnimatorSet();
        animSet.play(animatorFirst).before(animatorFirst);
        animSet.start();
        return animSet;
    }
}
