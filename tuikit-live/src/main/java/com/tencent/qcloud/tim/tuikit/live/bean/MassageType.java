...
public class MassageType {
    ...
    public static final String CHANGE_ROOM = "changeInfoAvChatRoom"; //更新信息
    ...
    public static final String LIVE_ANIMATION_MSG= "sendAnimationAvChatRoom";

    //关闭连麦者
    public static final String KICK_MIC_USER = "kickMicUser";
