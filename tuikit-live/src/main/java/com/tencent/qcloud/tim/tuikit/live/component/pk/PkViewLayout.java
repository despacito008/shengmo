...
public class PkViewLayout extends ConstraintLayout {
    ...
    public PkViewLayout(Context context) {
        super(context);
        initView(context);
    }

    public PkViewLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
        initView(context);
    }

    public PkViewLayout(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void initView(Context context) {
        mContext = context;
        mLayoutRoot = (ConstraintLayout) inflate(context, R.layout.live_layout_pk_view, this);
        initPkView();
        hidePkView();
    }
