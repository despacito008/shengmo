...
public class AlertView {
    ...
    protected void initData(String title, String msg, String cancel, String[] destructive, String[] others) {
        ...
        if (others != null) {
            ...
            List arrList = new ArrayList(mOthers);
    ...
    protected void initViews() {
        ...
        FrameLayout outcuscontainer = (FrameLayout) rootView.findViewById(R.id.outmost_container);
        outcuscontainer.setOnClickListener(new OnTextClickListener(CANCELPOSITION));
        ...
        switch (style) {
            case ActionSheet:
                ...
                params.setMargins(margin_alert_left_right, i, margin_alert_left_right, margin_alert_left_right);
