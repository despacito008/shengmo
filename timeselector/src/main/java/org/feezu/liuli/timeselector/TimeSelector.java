...
public class TimeSelector {
    ...
    public TimeSelector(Context context, ResultHandler resultHandler, String startDate, String endDate, int position) {
        this.context = context;
        this.handler = resultHandler;
        startCalendar = Calendar.getInstance();
        endCalendar = Calendar.getInstance();
    ...
    private void loadComponent() {
        ...
        if (currentPsition == -1 ){
            ...
            year_pv.setSelected(currentPsition);
            month_pv.setSelected(currentPsition);
            day_pv.setSelected(currentPsition);
            hour_pv.setSelected(currentPsition);
            minute_pv.setSelected(currentPsition);
        }
